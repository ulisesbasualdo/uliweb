...
@Component({
  ...
  template: `
    <div class="contacto">
      <div class="deslizador">
        ...
        <button
          class="opcion"
          [class.activo]="opcionActiva() === 'whatsapp'"
          (click)="cambiarOpcion('whatsapp')">
          WhatsApp
        </button>
        <button
          class="opcion"
        ...
        @switch (opcionActiva()) {
          @case ('email') {
            <div class="opcion-email">
              ...
              <button class="boton-enviar" (click)="enviarEmail()">Enviar</button>
            </div>
          }
          @case ('whatsapp') {
            <div class="opcion-whatsapp">
              <input type="text" placeholder="Tu nombre">
              <textarea placeholder="Tu mensaje"></textarea>
              <button class="boton-enviar" (click)="enviarWhatsapp()">Enviar por WhatsApp</button>
            </div>
          }
          @case ('linkedin') {
  ...
  styles: [`
    ...
    .opcion-email, .opcion-whatsapp, .opcion-linkedin {
      display: flex;
    ...
    .boton-enviar:hover, .boton-linkedin:hover {
...
export class DeslizadorContactoComponent {
  opcionActiva = signal<'email' | 'whatsapp' | 'linkedin'>('email');

  cambiarOpcion(opcion: 'email' | 'whatsapp' | 'linkedin') {
  ...
  enviarWhatsapp() {
    // Implementar lógica para enviar whatsapp
